/*
       ...
       Generated on: 2/10/2022 20:1:58.86
...
namespace GeneXus.Programs {
   public class apdf_marcas : GXWebProcedure, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public apdf_marcas( IGxContext context )
      {
      ...
      {
         apdf_marcas objapdf_marcas;
         objapdf_marcas = new apdf_marcas();
         objapdf_marcas.context.SetSubmitInitialConfig(context);
         objapdf_marcas.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objapdf_marcas);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((apdf_marcas)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         try
         {
            ...
            getPrinter().GxDrawText("CLAVE MARCA", 100, Gx_line+100, 179, Gx_line+119, 0, 0, 0, 0) ;
            ...
            getPrinter().GxDrawText("REPORTE DE MARCAS", 325, Gx_line+50, 525, Gx_line+68, 0, 0, 0, 0) ;
            Gx_OldLine = Gx_line;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         P000H2_A24marcasid = new int[1] ;
         P000H2_A112marcasdsc = new String[] {""} ;
         P000H2_n112marcasdsc = new bool[] {false} ;
         A112marcasdsc = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.apdf_marcas__default(),
            new Object[][] {
                new Object[] {
               P000H2_A24marcasid, P000H2_A112marcasdsc, P000H2_n112marcasdsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] P000H2_A24marcasid ;
      private String[] P000H2_A112marcasdsc ;
      private bool[] P000H2_n112marcasdsc ;
   }

   public class apdf_marcas__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000H2", "SELECT marcasid, marcasdsc FROM public.marcas ORDER BY marcasid ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000H2,100,0,false,false )
          };
       }
    }
