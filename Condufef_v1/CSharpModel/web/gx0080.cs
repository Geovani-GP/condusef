/*
       ...
       Generated on: 12/30/2021 22:9:24.57
...
namespace GeneXus.Programs {
   public class gx0080 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202112302292461");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblmarcasidfilter_Internalname, "marcasid", "", "", lblLblmarcasidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110e1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0080.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblmarcasdscfilter_Internalname, "marcasdsc", "", "", lblLblmarcasdscfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120e1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "left", "top");
            GxWebStd.gx_div_end( context, "left", "top");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblmarcasusuariofilter_Internalname, "marcasusuario", "", "", lblLblmarcasusuariofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130e1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "left", "top");
            GxWebStd.gx_div_end( context, "left", "top");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblmarcasfecregfilter_Internalname, "marcasfecreg", "", "", lblLblmarcasfecregfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140e1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "left", "top");
            GxWebStd.gx_div_end( context, "left", "top");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblmarcasfecultactfilter_Internalname, "marcasfecultact", "", "", lblLblmarcasfecultactfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e150e1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "left", "top");
            GxWebStd.gx_div_end( context, "left", "top");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e160e1_client"+"'", TempTags, "", 2, "HLP_Gx0080.htm");
            GxWebStd.gx_div_end( context, "left", "top");
            GxWebStd.gx_div_end( context, "left", "top");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void RF0E2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cmarcasusuario", AV8cmarcasusuario);
            /* Using cursor H000E2 */
            pr_default.execute(0, new Object[] {AV6cmarcasid, lV7cmarcasdsc, lV8cmarcasusuario, AV9cmarcasfecreg, AV10cmarcasfecultact, GXPagingFrom2, GXPagingTo2, GXPagingTo2, GXPagingFrom2, GXPagingFrom2});
            nGXsfl_64_idx = 1;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A115marcasfecultact = H000E2_A115marcasfecultact[0];
               n115marcasfecultact = H000E2_n115marcasfecultact[0];
               A114marcasfecreg = H000E2_A114marcasfecreg[0];
               n114marcasfecreg = H000E2_n114marcasfecreg[0];
               A113marcasusuario = H000E2_A113marcasusuario[0];
               n113marcasusuario = H000E2_n113marcasusuario[0];
               A112marcasdsc = H000E2_A112marcasdsc[0];
               n112marcasdsc = H000E2_n112marcasdsc[0];
               A24marcasid = H000E2_A24marcasid[0];
               /* Execute user event: E180E2 */
               E180E2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202112302292534");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0080.js", "?202112302292534");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E160E1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}],oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLMARCASIDFILTER.CLICK","{handler:'E110E1',iparms:[{av:'divMarcasidfiltercontainer_Class',ctrl:'MARCASIDFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divMarcasidfiltercontainer_Class',ctrl:'MARCASIDFILTERCONTAINER',prop:'Class'},{av:'edtavCmarcasid_Visible',ctrl:'vCMARCASID',prop:'Visible'}]}");
         setEventMetadata("LBLMARCASDSCFILTER.CLICK","{handler:'E120E1',iparms:[{av:'divMarcasdscfiltercontainer_Class',ctrl:'MARCASDSCFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divMarcasdscfiltercontainer_Class',ctrl:'MARCASDSCFILTERCONTAINER',prop:'Class'},{av:'edtavCmarcasdsc_Visible',ctrl:'vCMARCASDSC',prop:'Visible'}]}");
         setEventMetadata("LBLMARCASUSUARIOFILTER.CLICK","{handler:'E130E1',iparms:[{av:'divMarcasusuariofiltercontainer_Class',ctrl:'MARCASUSUARIOFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divMarcasusuariofiltercontainer_Class',ctrl:'MARCASUSUARIOFILTERCONTAINER',prop:'Class'},{av:'edtavCmarcasusuario_Visible',ctrl:'vCMARCASUSUARIO',prop:'Visible'}]}");
         setEventMetadata("LBLMARCASFECREGFILTER.CLICK","{handler:'E140E1',iparms:[{av:'divMarcasfecregfiltercontainer_Class',ctrl:'MARCASFECREGFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divMarcasfecregfiltercontainer_Class',ctrl:'MARCASFECREGFILTERCONTAINER',prop:'Class'}]}");
         setEventMetadata("LBLMARCASFECULTACTFILTER.CLICK","{handler:'E150E1',iparms:[{av:'divMarcasfecultactfiltercontainer_Class',ctrl:'MARCASFECULTACTFILTERCONTAINER',prop:'Class'}],oparms:[{av:'divMarcasfecultactfiltercontainer_Class',ctrl:'MARCASFECULTACTFILTERCONTAINER',prop:'Class'}]}");
         setEventMetadata("ENTER","{handler:'E190E2',iparms:[{av:'A24marcasid',fld:'MARCASID',pic:'ZZZZZZZZ9',hsh:true,nv:0}],oparms:[{av:'AV11pmarcasid',fld:'vPMARCASID',pic:'ZZZZZZZZ9',nv:0}]}");
      ...
      public override void initialize( )
      {
         ...
         H000E2_A115marcasfecultact = new DateTime[] {DateTime.MinValue} ;
         H000E2_n115marcasfecultact = new bool[] {false} ;
         H000E2_A114marcasfecreg = new DateTime[] {DateTime.MinValue} ;
         H000E2_n114marcasfecreg = new bool[] {false} ;
         H000E2_A113marcasusuario = new String[] {""} ;
         H000E2_n113marcasusuario = new bool[] {false} ;
         H000E2_A112marcasdsc = new String[] {""} ;
         H000E2_n112marcasdsc = new bool[] {false} ;
         H000E2_A24marcasid = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0080__default(),
            new Object[][] {
                new Object[] {
               H000E2_A115marcasfecultact, H000E2_n115marcasfecultact, H000E2_A114marcasfecreg, H000E2_n114marcasfecreg, H000E2_A113marcasusuario, H000E2_n113marcasusuario, H000E2_A112marcasdsc, H000E2_n112marcasdsc, H000E2_A24marcasid
               }
               , new Object[] {
      ...
      private DateTime[] H000E2_A115marcasfecultact ;
      private bool[] H000E2_n115marcasfecultact ;
      private DateTime[] H000E2_A114marcasfecreg ;
      private bool[] H000E2_n114marcasfecreg ;
      private String[] H000E2_A113marcasusuario ;
      private bool[] H000E2_n113marcasusuario ;
      private String[] H000E2_A112marcasdsc ;
      private bool[] H000E2_n112marcasdsc ;
      private int[] H000E2_A24marcasid ;
   ...
   public class gx0080__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV6cmarcasid )
      {
         ...
         sFromString = " FROM [marcas] WITH (NOLOCK)";
         sOrderString = "";
                                             ...
                                             int AV6cmarcasid )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [marcas] WITH (NOLOCK)";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000E2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (int)dynConstraints[8] );
               case 1 :
                     return conditional_H000E3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (DateTime)dynConstraints[2] , (DateTime)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (int)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV6cmarcasid",SqlDbType.Int,9,0} ,
          new Object[] {"@lV7cmarcasdsc",SqlDbType.VarChar,100,0} ,
          new Object[] {"@lV8cmarcasusuario",SqlDbType.VarChar,15,0} ,
          new Object[] {"@AV9cmarcasfecreg",SqlDbType.DateTime,10,8} ,
          new Object[] {"@AV10cmarcasfecultact",SqlDbType.DateTime,10,8} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000E2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E2,11,0,false,false )
             ,new CursorDef("H000E3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000E3,1,0,false,false )
          };
       }
    }
