...
using System.IO;
public class bldaacategoriasreporte : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaacategoriasreporte( ) : base()
   {
   }
   ...
   {
      bldaacategoriasreporte x = new bldaacategoriasreporte() ;
      x.SetMainSourceFile( "aacategoriasreporte.cs");
   ...
   public override TargetCollection GetRuntimeBuildList( )
   {
      ...
      sc.Add( @"aacategoriasreporte", "dll");
      return sc ;
   }
