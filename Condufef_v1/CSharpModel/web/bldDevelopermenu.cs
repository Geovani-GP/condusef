...
public class bldDevelopermenu : GxBaseBuilder
{
   ...
   public override TargetCollection GetRuntimeBuildList( )
   {
      ...
      sc.Add( @"alerts", "dll");
      sc.Add( @"gx00o0", "dll");
      sc.Add( @"detallesproveedores", "dll");
      sc.Add( @"detallesempleados", "dll");
      sc.Add( @"detallesempleadospiso", "dll");
      sc.Add( @"detallesalmacen", "dll");
      sc.Add( @"gx00p0", "dll");
      sc.Add( @"detallesproducto", "dll");
      sc.Add( @"masterlogin", "dll");
      sc.Add( @"register", "dll");
      sc.Add( @"tipobien", "dll");
