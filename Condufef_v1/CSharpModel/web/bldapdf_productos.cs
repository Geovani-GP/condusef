...
using System.IO;
public class bldapdf_productos : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapdf_productos( ) : base()
   {
   }
   ...
   {
      bldapdf_productos x = new bldapdf_productos() ;
      x.SetMainSourceFile( "apdf_productos.cs");
