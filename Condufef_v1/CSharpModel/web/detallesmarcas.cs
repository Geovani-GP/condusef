/*
       ...
       Generated on: 1/27/2022 13:43:46.36
...
namespace GeneXus.Programs {
   public class detallesmarcas : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Marcagrid") == 0 )
            {
               ...
               gxgrMarcagrid_refresh( AV6updateImage, AV7deleteImage, A24marcasid, A112marcasdsc, AV5buscar) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202212713434637");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void gxgrMarcagrid_refresh( String AV6updateImage ,
      ...
      private void E152K2( )
      {
         ...
         while ( (pr_default.getStatus(0) != 101) && ( H002K2_A24marcasid[0] == A24marcasid ) )
         {
            BRK2K2 = false;
            A112marcasdsc = H002K2_A112marcasdsc[0];
            n112marcasdsc = H002K2_n112marcasdsc[0];
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV5buscar)) || ( ( StringUtil.StrCmp(A112marcasdsc, AV5buscar) == 0 ) ) )
            {
               /* Load Method */
               if ( wbStart != -1 )
               {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202212713434645");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("detallesmarcas.js", "?202212713434645");
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'MARCAGRID_nFirstRecordOnPage',nv:0},{av:'MARCAGRID_nEOF',nv:0},{av:'AV6updateImage',fld:'vUPDATEIMAGE',pic:'',nv:''},{av:'AV7deleteImage',fld:'vDELETEIMAGE',pic:'',nv:''},{av:'A24marcasid',fld:'MARCASID',pic:'ZZZZZZZZ9',hsh:true,nv:0},{av:'A112marcasdsc',fld:'MARCASDSC',pic:'',hsh:true,nv:''},{av:'AV5buscar',fld:'vBUSCAR',pic:'',nv:''}],oparms:[]}");
         ...
         setEventMetadata("MARCAGRID.LOAD","{handler:'E152K2',iparms:[{av:'A24marcasid',fld:'MARCASID',pic:'ZZZZZZZZ9',hsh:true,nv:0},{av:'A112marcasdsc',fld:'MARCASDSC',pic:'',hsh:true,nv:''},{av:'AV5buscar',fld:'vBUSCAR',pic:'',nv:''}],oparms:[]}");
         return  ;
      }
   ...
   public class detallesmarcas__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002K2", "SELECT marcasdsc, marcasid FROM public.marcas ORDER BY marcasid ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K2,11,0,true,false )
          };
       }
    }
