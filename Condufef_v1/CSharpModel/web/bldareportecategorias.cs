...
using System.IO;
public class bldareportecategorias : GxBaseBuilder
{
   string cs_path = "." ;
   public bldareportecategorias( ) : base()
   {
   }
   ...
   {
      bldareportecategorias x = new bldareportecategorias() ;
      x.SetMainSourceFile( "areportecategorias.cs");
