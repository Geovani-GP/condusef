/*
       ...
       Generated on: 1/26/2022 20:7:45.77
...
namespace GeneXus.Programs {
   public class menuprincipal : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public menuprincipal( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20221262074578");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         return formatLink("menuprincipal.aspx")  ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_3_0T2( true) ;
         }
         else
         {
            wb_table1_3_0T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_3_0T2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</p>") ;
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Menu Principal", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void wb_table1_3_0T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_3_0T2e( true) ;
         }
         else
         {
            wb_table1_3_0T2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20221262074582");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("menuprincipal.js", "?20221262074582");
         }
