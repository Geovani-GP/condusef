...
namespace GeneXus.Programs {
   public class masterlogin : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public masterlogin( )
      {
      ...
      public masterlogin( IGxContext context )
      {
      ...
      protected void wb_table1_2_3A2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:296px")+"\">") ;
            wb_table2_5_3A2( true) ;
         }
         else
         {
            wb_table2_5_3A2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_3A2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table2_5_3A2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td data-align=\"center\" bgcolor=\"#808080\"  style=\""+CSSHelper.Prettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center;height:56px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "BIENVENIDO", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "font-family:'Microsoft Sans Serif'; font-size:20.0pt; font-weight:bold; font-style:normal; color:#000000;", "TextBlock", 0, "", 1, 1, 0, "HLP_MasterLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:160px")+"\">") ;
            if ( context.isSpaRequest( ) )
            {
               enableOutput();
            }
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_3A2e( true) ;
         }
         else
         {
            wb_table2_5_3A2e( false) ;
         }
      }
