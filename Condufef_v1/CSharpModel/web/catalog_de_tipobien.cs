/*
       ...
       Generated on: 3/31/2022 0:19:35.39
...
namespace GeneXus.Programs {
   public class catalog_de_tipobien : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20223310193540");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB2S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_4_2S2( true) ;
         }
         else
         {
            wb_table1_4_2S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_4_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</p>") ;
      ...
      protected void wb_table1_4_2S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock8_Internalname, "CATÁLOGO DE TIPO BIEN", "", "", lblTextblock8_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "font-family:'Microsoft Sans Serif'; font-size:15.0pt; font-weight:bold; font-style:normal; color:#000000;", "TextBlock", 0, "", 1, 1, 0, "HLP_Catalog_De_TipoBien.htm");
      ...
      protected void wb_table3_19_2S2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table1_4_2S2e( true) ;
         }
         else
         {
            wb_table1_4_2S2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20223310193550");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_tipobien.js", "?20223310193550");
