/*
       ...
       Generated on: 1/30/2022 23:38:6.4
...
namespace GeneXus.Programs {
   public class catalog_de_tipo_doc : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022130233866");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      {
         /* 'Guardar ' Routine */
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV8tipodocumentodsc)) )
         {
      ...
      protected void wb_table1_6_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_11_0Y2( true) ;
         }
         else
         {
            wb_table2_11_0Y2( false) ;
         }
         return  ;
      }

      protected void wb_table2_11_0Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_20_0Y2( true) ;
         }
         else
         {
            wb_table3_20_0Y2( false) ;
         }
         return  ;
      }

      protected void wb_table3_20_0Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_20_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_20_0Y2e( true) ;
         }
         else
         {
            wb_table3_20_0Y2e( false) ;
         }
      }

      protected void wb_table2_11_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipodocumentodsc_Internalname, AV8tipodocumentodsc, StringUtil.RTrim( context.localUtil.Format( AV8tipodocumentodsc, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipodocumentodsc_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Catalog_De_Tipo_Doc.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_11_0Y2e( true) ;
         }
         else
         {
            wb_table2_11_0Y2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20221302338624");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_tipo_doc.js", "?20221302338624");
         context.AddJavascriptSource("Shared/jquery/jquery-1.9.0.js", "");
         context.AddJavascriptSource("Alertify/js/alertify.min.js", "");
         context.AddJavascriptSource("Alertify/GlobalAlerts.js", "");
         context.AddJavascriptSource("Alertify/AlertifyRender.js", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GUARDAR '","{handler:'E120Y2',iparms:[{av:'AV8tipodocumentodsc',fld:'vTIPODOCUMENTODSC',pic:'',nv:''},{av:'AV6NextValue',fld:'vNEXTVALUE',pic:'ZZZ9',hsh:true,nv:0},{av:'AV7tipodocumento',fld:'vTIPODOCUMENTO',pic:'',nv:null},{av:'Gx_date',fld:'vTODAY',pic:'',nv:''}],oparms:[{av:'AV7tipodocumento',fld:'vTIPODOCUMENTO',pic:'',nv:null}]}");
