/*
       ...
       Generated on: 1/28/2022 11:56:27.77
...
namespace GeneXus.Programs {
   public class catalog_de_tipo_doc : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202212811562779");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTIPODOCUMENTO", AV7tipodocumento);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTIPODOCUMENTO", AV7tipodocumento);
         }
         ...
         forbiddenHiddens = "hsh" + "Catalog_De_Tipo_Doc";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format( (decimal)(AV6NextValue), "ZZZ9");
         GxWebStd.gx_hidden_field( context, "hsh", GXUtil.GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("catalog_de_tipo_doc:[SendSecurityCheck value for]"+"NextValue:"+context.localUtil.Format( (decimal)(AV6NextValue), "ZZZ9"));
      }
      ...
      protected void STRUP0Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8tipodocumentodsc = cgiGet( edtavTipodocumentodsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8tipodocumentodsc", AV8tipodocumentodsc);
            /* Read saved values. */
            ...
            {
               GXUtil.WriteLog("catalog_de_tipo_doc:[SecurityCheckFailed value for]"+"NextValue:"+context.localUtil.Format( (decimal)(AV6NextValue), "ZZZ9"));
               GxWebError = 1;
      ...
      {
         /* 'Guardar ' Routine */
         AV7tipodocumento.gxTpr_Tipodocumentoid = AV6NextValue;
         AV7tipodocumento.gxTpr_Tipodocumentodsc = AV8tipodocumentodsc;
         GXt_dtime1 = DateTimeUtil.ResetTime( Gx_date ) ;
         AV7tipodocumento.gxTpr_Tipodocumentofecreg = GXt_dtime1;
         AV7tipodocumento.gxTpr_Tipodocumentousuario = AV10WebSession.Get("usuario");
         AV7tipodocumento.Save();
         if ( AV7tipodocumento.Success() )
         {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV7tipodocumento", AV7tipodocumento);
      }
      ...
      {
         /* 'Consultar ' Routine */
         context.wjLoc = formatLink("detalletipodocumento.aspx") ;
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void wb_table2_8_0Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_17_0Y2( true) ;
         }
         else
         {
            wb_table3_17_0Y2( false) ;
         }
         return  ;
      }

      protected void wb_table3_17_0Y2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_17_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_17_0Y2e( true) ;
         }
         else
         {
            wb_table3_17_0Y2e( false) ;
         }
      }
      ...
      protected void wb_table2_8_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            context.WriteHtmlText( "Tipo Documento") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 12,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavNextvalue_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6NextValue), 4, 0, ",", "")), ((edtavNextvalue_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6NextValue), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6NextValue), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,12);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavNextvalue_Jsonclick, 0, "Attribute", "", "", "", 1, edtavNextvalue_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Catalog_De_Tipo_Doc.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            GxWebStd.gx_single_line_edit( context, edtavTipodocumentodsc_Internalname, AV8tipodocumentodsc, StringUtil.RTrim( context.localUtil.Format( AV8tipodocumentodsc, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTipodocumentodsc_Jsonclick, 0, "Attribute", "", "", "", 1, 1, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Catalog_De_Tipo_Doc.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202212811562786");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_tipo_doc.js", "?202212811562786");
      ...
      public override void initialize_properties( )
      {
         ...
         edtavTipodocumentodsc_Jsonclick = "";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GUARDAR '","{handler:'E120Y2',iparms:[{av:'AV6NextValue',fld:'vNEXTVALUE',pic:'ZZZ9',hsh:true,nv:0},{av:'AV7tipodocumento',fld:'vTIPODOCUMENTO',pic:'',nv:null},{av:'AV8tipodocumentodsc',fld:'vTIPODOCUMENTODSC',pic:'',nv:''},{av:'Gx_date',fld:'vTODAY',pic:'',nv:''}],oparms:[{av:'AV7tipodocumento',fld:'vTIPODOCUMENTO',pic:'',nv:null}]}");
         setEventMetadata("'CANCELAR'","{handler:'E130Y2',iparms:[],oparms:[]}");
         setEventMetadata("'CONSULTAR '","{handler:'E140Y2',iparms:[],oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         FormProcess = "";
         bodyStyle = "";
         AV7tipodocumento = new Sdttipodocumento(context);
      ...
      private String edtavTipodocumentodsc_Internalname ;
      private String hsh ;
      ...
      private String edtavTipodocumentodsc_Jsonclick ;
      ...
      private String AV8tipodocumentodsc ;
      ...
      private Sdttipodocumento AV7tipodocumento ;
   }
   ...
   public class catalog_de_tipo_doc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Y3", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT MAX(tipodocumentoid) AS GXC1 FROM public.tipodocumento ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Y3,1,0,true,false )
             ,new CursorDef("H000Y5", "SELECT COALESCE( T1.GXC1, 0) AS GXC1 FROM (SELECT MAX(tipodocumentoid) AS GXC1 FROM public.tipodocumento ) T1 ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Y5,1,0,true,false )
          };
       }
    }
