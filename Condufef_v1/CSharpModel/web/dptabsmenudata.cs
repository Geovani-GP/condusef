/*
       ...
       Generated on: 1/30/2022 23:37:14.53
...
namespace GeneXus.Programs {
   public class dptabsmenudata : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GxObjectCollection( context, "TabsMenuData.TabsMenuDataItem", "Condufef_v1", "SdtTabsMenuData_TabsMenuDataItem", "GeneXus.Programs") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out IGxCollection aP0_Gxm2rootcol )
      {
         ...
         objdptabsmenudata.Gxm2rootcol = new GxObjectCollection( context, "TabsMenuData.TabsMenuDataItem", "Condufef_v1", "SdtTabsMenuData_TabsMenuDataItem", "GeneXus.Programs") ;
         objdptabsmenudata.context.SetSubmitInitialConfig(context);
         objdptabsmenudata.initialize();
         ThreadPool.QueueUserWorkItem( PropagateCulture(new WaitCallback( executePrivateCatch )),objdptabsmenudata);
         aP0_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((dptabsmenudata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
