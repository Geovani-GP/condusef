...
using System.IO;
public class bldacategoriasreporte : GxBaseBuilder
{
   string cs_path = "." ;
   public bldacategoriasreporte( ) : base()
   {
   }
   ...
   {
      bldacategoriasreporte x = new bldacategoriasreporte() ;
      x.SetMainSourceFile( "acategoriasreporte.cs");
