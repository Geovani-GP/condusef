/*
       ...
       Generated on: 1/29/2022 0:44:55.93
...
namespace GeneXus.Programs {
   public class catalog_de_proveedor : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20221290445594");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_2_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_2Q2( true) ;
         }
         else
         {
            wb_table2_5_2Q2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_36_2Q2( true) ;
         }
         else
         {
            wb_table3_36_2Q2( false) ;
         }
         return  ;
      }

      protected void wb_table3_36_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_36_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_36_2Q2e( true) ;
         }
         else
         {
            wb_table3_36_2Q2e( false) ;
         }
      }

      protected void wb_table2_5_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_2Q2e( true) ;
         }
         else
         {
            wb_table2_5_2Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022129044564");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_proveedor.js", "?2022129044564");
