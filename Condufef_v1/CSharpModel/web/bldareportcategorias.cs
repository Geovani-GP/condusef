...
using System.IO;
public class bldareportcategorias : GxBaseBuilder
{
   string cs_path = "." ;
   public bldareportcategorias( ) : base()
   {
   }
   ...
   {
      bldareportcategorias x = new bldareportcategorias() ;
      x.SetMainSourceFile( "areportcategorias.cs");
