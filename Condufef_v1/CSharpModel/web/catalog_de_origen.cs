/*
       ...
       Generated on: 1/27/2022 21:49:5.59
...
namespace GeneXus.Programs {
   public class catalog_de_origen : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20221272149561");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20221272149571");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_origen.js", "?20221272149571");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GUARDAR '","{handler:'E12142',iparms:[{av:'AV6NextValue',fld:'vNEXTVALUE',pic:'ZZZ9',nv:0},{av:'AV14origen',fld:'vORIGEN',pic:'',nv:null},{av:'AV8origendscorta',fld:'vORIGENDSCORTA',pic:'',nv:''},{av:'AV9origendsclarga',fld:'vORIGENDSCLARGA',pic:'',nv:''},{av:'Gx_date',fld:'vTODAY',pic:'',nv:''}],oparms:[{av:'AV14origen',fld:'vORIGEN',pic:'',nv:null}]}");
