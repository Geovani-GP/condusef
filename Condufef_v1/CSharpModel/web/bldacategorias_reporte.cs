...
using System.IO;
public class bldacategorias_reporte : GxBaseBuilder
{
   string cs_path = "." ;
   public bldacategorias_reporte( ) : base()
   {
   }
   ...
   {
      bldacategorias_reporte x = new bldacategorias_reporte() ;
      x.SetMainSourceFile( "acategorias_reporte.cs");
