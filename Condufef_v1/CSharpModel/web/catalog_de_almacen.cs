/*
       ...
       Generated on: 1/28/2022 1:41:3.76
...
namespace GeneXus.Programs {
   public class catalog_de_almacen : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022128141378");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_2_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_2R2( true) ;
         }
         else
         {
            wb_table2_5_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table3_24_2R2( true) ;
         }
         else
         {
            wb_table3_24_2R2( false) ;
         }
         return  ;
      }

      protected void wb_table3_24_2R2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table3_24_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_24_2R2e( true) ;
         }
         else
         {
            wb_table3_24_2R2e( false) ;
         }
      }

      protected void wb_table2_5_2R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_2R2e( true) ;
         }
         else
         {
            wb_table2_5_2R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022128141389");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("catalog_de_almacen.js", "?2022128141389");
