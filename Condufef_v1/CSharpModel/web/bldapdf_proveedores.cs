...
using System.IO;
public class bldapdf_proveedores : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapdf_proveedores( ) : base()
   {
   }
   ...
   {
      bldapdf_proveedores x = new bldapdf_proveedores() ;
      x.SetMainSourceFile( "apdf_proveedores.cs");
